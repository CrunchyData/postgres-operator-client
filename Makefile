...
cli-docs: ## generate cli documenation	
	rm docs/content/reference/*.md
	cd docs/content/reference && go run ../../../cmd/pgo/generatedocs.go
	sed -e '1,5 s|^title:.*|title: "PGO Client Reference"|' \
		docs/content/reference/kubectl-pgo.md > \
		docs/content/reference/_index.md
	rm docs/content/reference/kubectl-pgo.md
