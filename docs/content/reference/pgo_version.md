...
```
  ...
  -n, --namespace string               If present, the namespace scope for this CLI request
      --pgo-api-version string         PostgresCluster API version to use (v1 or v1beta1). Defaults to PGO_API_VERSION env var, then auto-detect, then v1beta1.
